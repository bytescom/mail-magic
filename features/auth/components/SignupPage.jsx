    ...
    return (
        <section className="relative min-h-screen flex overflow-hidden animate-page-transition p-2 bg-slate-50">
                ...
                <div className="w-full max-w-[380px] flex flex-col gap-8 mt-12">
                    <div className="text-center space-y-3">
                        ...
                        <p className="text-sm text-gray-500 font-medium">
                            Signup with your Google account to continue
                        </p>
                    </div>
            ...
            <div className="hidden lg:flex w-[55%] shrink-0 h-[calc(100vh-16px)] sticky top-0 rounded-2xl overflow-hidden">
                <div className="relative w-full h-full bg-slate-950 flex flex-col justify-between items-end p-10">
                    {/* Bg image cover */}
                    <div
                    ...
                    {/* Bottom content */}
                    <div className="relative z-10 space-y-4 max-w-sm mb-4 flex flex-col items-end">
                        <h2 className={`text-5xl font-semibold tracking-tight text-white leading-[1.1] text-right ${serif.className}`}>
                            Get<br />Everything<br />You Want
                        </h2>
                        <p className="text-sm font-normal text-white/80 leading-relaxed mt-6 text-right">
