                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    {selectedLog && (
                        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 text-sans">
                            ...
                            <div className="bg-white max-w-3xl w-full rounded-[2.5rem] shadow-2xl relative z-10 animate-in slide-in-from-bottom-5 duration-500 flex flex-col max-h-[90vh] overflow-hidden">
                                ...
                                <div className="flex-1 overflow-y-auto p-10 space-y-10">
                                    ...
                                    <div className="space-y-4">
                                        <div className="p-8 rounded-[2rem] bg-slate-50 border border-slate-200/60 shadow-inner relative overflow-hidden group">
