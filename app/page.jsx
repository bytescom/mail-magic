        ...
        <div className="min-h-screen bg-[#FDFDFF] overflow-hidden font-sans selection:bg-blue-100 selection:text-blue-900">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col items-center text-center space-y-8">
                        ...
                        <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-blue-50/50 border border-blue-100 animate-in fade-in slide-in-from-top-4 duration-1000">
                            <Sparkles className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 text-blue-700" />
                            <span className="text-[9px] sm:text-[11px] font-bold text-blue-700 uppercase tracking-[0.2em]">Next-Gen Job Outreach</span>
                        </div>

                        {/* Heading */}
                        <div className="space-y-6 max-w-4xl animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-200">
                            <h1 className="text-[47px] sm:text-6xl md:text-7xl font-display font-bold text-slate-900 tracking-tight leading-[1.1]">
                            ...
                            <p className="text-md sm:text-lg md:text-xl text-slate-500 max-w-2xl mx-3 leading-tigher tracking-tight md:tracking-tight sm:leading-relaxed font-medium align-center">
                        ...
                        <div className="flex flex-col items-center gap-7 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500 pb-10">
                            ...
                            >
                                ...
                                <span className="text-[13px] sm:text-sm md:text-base tracking-tight font-display">Continue with Google</span>
            ...
            <footer className="bg-white border-t border-slate-100 py-12">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                    <Link href="https://github.com/bytescom">
