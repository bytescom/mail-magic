                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col items-center text-center space-y-10">
                        ...
                        <div className="flex flex-col items-center gap-6 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
                            <button
                                onClick={handleSignIn}
                                className="w-full max-w-md px-8 py-4 md:px-12 md:py-5 rounded-2xl bg-blue-600 text-white font-bold inline-flex items-center justify-center gap-2 md:gap-3 group transition-all hover:bg-blue-700 active:scale-[0.98] shadow-xl shadow-blue-600/20 cursor-pointer"
                            >
                                ...
                                <span className="text-sm md:text-base tracking-tight font-display">Continue with Google</span>
